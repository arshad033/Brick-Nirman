      ...
      <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        <form action="#" className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <ol className="items-center flex w-full max-w-2xl text-center text-md font-medium text-gray-500 dark:text-gray-400 sm:text-base">
            ...
            <li className="flex shrink-0 items-center">Payment</li>
          </ol>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    <div className="flex w-40 mx-auto mt-4 items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">
                      Quantity:
                      <input
                        min="0"
                        type="number"
                        className="w-16 border-none focus:ring-0 focus:outline-none"
                      />
                    </div>
                  </div>
                </div>
